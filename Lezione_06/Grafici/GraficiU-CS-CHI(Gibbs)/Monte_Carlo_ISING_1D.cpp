...
void Averages(int iblk) //Print results for current block
{
   ...
   // cout << "Acceptance rate " << accepted/attempted << endl << endl;
    ...
    DatiCS.open("DatiCS",ios::app);
    DatiU.open("DatiU",ios::app);
    DatiCHI.open("DatiCHI",ios::app);
    ...
    if(iblk == nblk){
      DatiU << temp << " " << glob_av[iu]/(double)iblk << " " << err_u << endl;
      DatiCS << temp << " " << glob_av[ic]/(double)iblk << " " << err_c << endl;
      DatiCHI << temp << " " << glob_av[ix]/(double)iblk << " " << err_x << endl;
      cout << temp << " " << glob_av[iu]/(double)iblk << " " << err_u << endl;
      cout << temp << " " << glob_av[ic]/(double)iblk << " " << err_c << endl;
      cout << temp << " " << glob_av[ix]/(double)iblk << " " << err_x << endl;
    }   
