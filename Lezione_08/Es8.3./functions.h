...
void translation(Random* rnd); // performs a rigid translation
void brownianBridge(Random* rnd);  // reconstructs a segment of the polymer with a free particle propagation. 
void brownianMotion(int,Random*);  // reconstructs a segment at the extremities of the polymer with a free particle propagation. 
